...
So, I shifted to digital notes to try solve this problem. What have I tried? Google Docs and Drive, OneNote, BookStack, Wiki.js, Confluence, Notion, Evernote, Obsidian, Google Keep, and others.
...
1. ‍ Objects - all things are objects in AnyType ‍
2. Types - categorise the Objects you create to have a Type ‍
3. Properties - attach metadata to Types and create relations between them ‍
4. Query - List view showing a single Object/Type
5. ‍ Collections - Folder-like collection of different Objects/Types
6. ‍ Templates - speed up your workflow with pre-defined templates for object creation
   For example, to create a Book tracking system, you could define:‍
7. Book type with the properties: Title, GoodreadsUrl, and links to an Author
8. Author type with the properties: name & bio‍
9. Quote type with a property that links to our Book
   ...
   Conceptual example of how Book types could relate to each other in AnyType
   ‍
   AnyType Graph View of example Book objects

## Quickly explaining PARA

If you’re new to Tiago Forte’s PARA methodology, you’re in for a treat. PARA is a simple yet powerful system to organise your digital life—whether that’s notes, projects, or files—into four clear categories. It stands for:
...
I created a Template Space that should be available to copy from the AnyGallery once my github submission is accepted. For now, I'll explain how it works below:
...
Recently AnyType added an official API and Model Context Protocol (MCP) server. This advancement allows AI agents and assistants to interact with and update your documentation directly. In the docs here they highlight RayCast.ai for seamless AI Chatbot integration and workflows.
